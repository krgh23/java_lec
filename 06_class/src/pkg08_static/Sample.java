 ...
 *          종류 : static            지역변수               new 키워드로 생항하는 것(인스턴스, 배열)
 ...
 */
  ...
  static String item; // 클래스 멤버
  String item2;       // 인스턴스 멤버
  
  // 인스턴스 멤버
  public void methodA() {
    System.out.println("인스턴스 methodA");
  ...
  public static void methodB() {
    System.out.println("인스턴스 methodB");    
    System.out.println(item);
