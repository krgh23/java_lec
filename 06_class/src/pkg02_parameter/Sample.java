 ...
 * 메소드 만드는 방법
 * 
 * 반환타입 메소드명([매개변수, ...]) {     // [] 대괄호 내용 생략가능
 *   본문
 *   [return 반환값]                        // [] 대괄호 내용 생략가능 
 * }
 */
...
public class Sample {
  ...
  /**
   * @param car car 클래스 타입의 인스턴스를 전달받는다.
   * @param city string 타입의 도시이름을 전달받는다.
   */
  
  void methodD(Car car, String city) {
//    System.out.println(city + "으로 ");
    car.drive(city);  //city 를 drive 메소드에인자로 사용
  }
