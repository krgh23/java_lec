...
public class TrycCatchEx {
  ...
  public static void a() {
    ...
    // 예외 처리 코드를 catch 블록에 작성한다.
      ...
      System.out.println("정수만 변환 할 수 있습니다.");
    }
  ...
  public static void b() {
    ...
    // 다중 catch 블록 : 자식 클래스의 타입의 예외 처리를 먼저해야 한다.
    
    try {
      String[] userInputs = {"10", "20", "삼십", "40"};
     ...
     System.out.println( "사용할 수 없는 인덱스가 존재 합니다.");
    } catch(RuntimeException e) {
      System.out.println("실행 중 알 수없는 예외가 발생했습니다.");
    }
