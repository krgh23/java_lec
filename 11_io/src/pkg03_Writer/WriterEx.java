...
public class WriterEx {
  ...
  public static void a() {
    ...
    File file = new File("\\storage", "a.txt"); // File file = new File("\\storage\\a.txt");
    ...
    try (FileWriter out = new FileWriter(file)) {
      ...
      // 여러 문자 출력 : char[]
      char[] cbuf = "녕하".toCharArray();  // cha[] cbuf = new char[] {'녕', '하'};
      out.write(cbuf);
  ...
  public static void b() {
    ...
    try (BufferedWriter out = new BufferedWriter(new FileWriter(file))) {
      ...
      // BufferedWriter 클래스가 지원하는 줄 빠꿈 메소드 : newLine()
      out.write("<script>");
      out.newLine();
